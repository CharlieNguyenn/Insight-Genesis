      ...
      <div className="popup-upload-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="popup-upload-content">
          ...
          <ul className="popup-upload-list">
            <li><span className="dot" />Please ensure that you either own the copyright for any audio files you upload, or that you have obtained the necessary permissions to share them on InsightGenie.</li>
          ...
          <p className="popup-upload-terms">
            By clicking 'Agree and upload', you agree to the InsightGenie's <a href="#" className="popup-upload-link">Terms of Service</a> and <a href="#" className="popup-upload-link">Privacy Policy</a>.
          </p>
        </div>
