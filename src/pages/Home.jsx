      ...
      <section className="evolution">
        ...
        <div className="container">
          <div className="evolution-content">
            <div className="evolution-text-section">
              <h2 className="evolution-title">THE FUTURE OF AI INSIGHT</h2>
              <p className="evolution-description">
              As AI insights platforms continue to evolve, their role in shaping decentralized data ecosystems 
              and tokenization will be pivotal in driving innovation and user empowerment.
              </p>
            </div>
